    ...
    return (
    	<div className="loginDiv">
	      <Form onSubmit={this.handleSubmit} className="login-form">
	        <FormItem label="Username" labelCol={{ span: 4 }} wrapperCol={{ span: 6 }}>
	        ...
	        <FormItem label="E-mail" labelCol={{ span: 4 }} wrapperCol={{ span: 6 }} hasFeedback>
	        ...
	        <FormItem label="Password" labelCol={{ span: 4 }} wrapperCol={{ span: 6 }} hasFeedback>
	        ...
	        <FormItem label="Confirm Password" labelCol={{ span: 4 }} wrapperCol={{ span: 6 }} hasFeedback>
